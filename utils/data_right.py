...
class VisualOdometryDataLoaderRight(Dataset):
    ...
    def get_image_paths(self, sequence, index):
        image_path = os.path.join(self.base_path, 'KITTI_sequences', sequence, 'image_3', f'{index:06}.png')
        return image_path
...
def main():
    ...
    dataset = VisualOdometryDataLoaderRight(path, 192, 640)
