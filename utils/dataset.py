...
class VisualOdometryDataLoader(Dataset):
...
def main():
    path = "/home/krmzyc/ubuntudisk/KITTI_Odometry"
    dataset = VisualOdometryDataLoader(path, 192, 640)
